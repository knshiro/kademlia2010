...
test_find_node :   test_kademlia_find_node.o kademlia.o md5.o store_file.o node.o XORmetrics.o
	${CC} -o $@ $^ ${LIBS}

test_find_value :   test_kademlia_find_value.o kademlia.o md5.o store_file.o node.o XORmetrics.o
	${CC} -o $@ $^ ${LIBS}
